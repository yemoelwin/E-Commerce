...
import { clearErrorMessage, forgotPasswordToken } from '../../features/auth/AuthSlice';
        ...
        onSubmit: async (values) => {
            try {
                ...
                if (response.error) {
                    ...
                    showToast('A reset password link has been sent to your email.', 'info')
                    formik.resetForm();
                }
            } catch (error) {
                        ...
                        <div className="form-container">
                            ...
                            <form className="form-horizontal" onSubmit={formik.handleSubmit}>
                                ...
                                <div>
                                    <button
                                        className="btn"
                                        type='submit'>{isLoading ? 'Submitting...' : 'Submit'}
                                    </button>
                                    <Link to={'/login'} className='forgot-password-cancel'>Cancel</Link>
                                </div>
