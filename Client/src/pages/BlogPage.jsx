...
const BlogPage = () => {
	...
	const [afterBlogPaginationData, setBlogPagination] = useState([]);
				...
				<div className='row'>
					<div className='col-3'>
						<div className='filter-card mb-3'>
							<h3 className='filter-title1'>Find By Categories</h3>
							<div>
						...
						<div className='filter-card mb-3'>
							<h3 className='filter-title1'>Popular Topics</h3>
							<div>
								<ul className='ps-0 topics'>
					...
					<div className='col-9'>
						<div className=''>
							<div className='col-12 px-4 cartmargin'>
								{isLoading ? ( // Show loading indicator when isLoading is true
									...
									<div className='grid-container'>
										<BlogCart
											blogData={
												afterBlogPaginationData ? afterBlogPaginationData : []
											}
										/>
									</div>
								)}
							...
							<Paginate
								items={blogState}
								perPage={4}
								setPaginateDisplay={setBlogPagination}
							/>
						</div>
					</div>
				</div>
