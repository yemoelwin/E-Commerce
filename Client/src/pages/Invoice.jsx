				...
				<Document>
					<Page size='A4' style={styles.page} wrap>
						...
						<View style={styles.section}>
							...
							<Text style={styles.text}>
								Customer Name: {orderData.customer_details.name}
							</Text>
							<Text style={styles.text}>
								Email: {orderData.customer_details.email}
							</Text>
							<Text style={styles.text}>
								Mobile: {orderData.customer_details.phone}
							</Text>
							...
							<View style={styles.product}>
								<Text style={styles.text}>
									Street: {orderData.shipping_details.address.line1},
									{orderData.shipping_details.address.line2}
								</Text>
								<Text style={styles.text}>
									City: {orderData.shipping_details.address.city}
								</Text>
								<Text style={styles.text}>
									State: {orderData.shipping_details.address.state}
								</Text>
								<Text style={styles.text}>
									Country: {orderData.shipping_details.address.country}
								</Text>
							</View>
						</View>
						...
						<View style={styles.section} break>
							...
							<Text style={styles.text}>
								SubTotal Amount: $ {orderData.subTotalAmount.toFixed(2)}
							</Text>
						</View>
