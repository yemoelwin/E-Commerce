                ...
                <div className="col-md-12">
                    ...
                    <div className="invoice">
                        ...
                        <div className="invoice-header">
                            <div className="invoice-from">
                                ...
                                <address className="m-t-5 m-b-5">
                                    <strong className="text-inverse text-modify">ShopSphere</strong><br />
                                    <span>Mobile: (95) 9257879097</span><br />
                            ...
                            <div className="invoice-to">
                                ...
                                <address className="m-t-5 m-b-5">
                                    ...
                                    <span>
                                        ...
                                        Postal Code: {orderData?.customer_details?.address?.postal_code}
                                    </span><br />
                                    <span>Mobile: {orderData?.customer_details?.phone}</span><br />
                                </address>
                            </div>
                            ...
                            <div className="table-responsive">
                                ...
                                <table className="table table-invoice">
                                    ...
                                    <thead>
                                        <tr>
                                            <th>UNIT NAME</th>
                                            <th className="text-center" width="15%">UNIT AMOUNT</th>
                                            <th className="text-center" width="10%">QUANTITY</th>
                                            <th className="text-right" width="20%">TOTAL AMOUNT</th>
                                        </tr>
                                    </thead>
                        ...
                        <div className="invoice-note">
                            <p>* Make all cheques payable to [ <span> shopsphere </span> ] </p>
                            <p>* Payment is due within 30 days </p>
                            <p className='d-flex'>* If you have any questions concerning this invoice, contact to
                                [
                                <li>yemoelwin,</li>
                                <li><Link to={`tel:+959257879097`}>+959257879097</Link>,</li>
                                <li><Link to={`mailto:yemoelwin@gmail.com`}>yemoelwin142@gmail.com</Link></li>
                                ]                                
                            </p>
                        </div>
                        ...
                        <div className="invoice-footer">
                            ...
                            <span className="m-r-10"><i className="fa fa-fw fa-lg fa-globe"></i> shopsphere.com</span>
                            <span className="m-r-10"><i className="fa fa-fw fa-lg fa-phone-volume"></i> Tel:95-9257879097</span>
                            <span className="m-r-10"><i className="fa fa-fw fa-lg fa-envelope"></i> shopsphereone609@gmail.com</span>
                            </p>
                        </div>
