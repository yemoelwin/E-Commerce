...
import { getInvoiceData } from "../features/users/userSlice";
...
const CheckoutSuccess = () => {
	...
	useEffect(() => {
		...
		const fetchData = async () => {
			try {
				await dispatch(getInvoiceData({ userId, transitionId }));
			} catch (error) {
			...
			<div className='container'>
				<div className='col-md-12'>
					{isLoading ? ( // Show loading indicator when isLoading is true
						...
						<>
							<div className='back-to-orderlist'>
								<Link to={`/orderlists/${userId}`}>
