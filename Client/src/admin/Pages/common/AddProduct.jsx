...
const AddProduct = () => {
	...
	const productId =
		productIdSegment === "undefined" ? undefined : productIdSegment;
	...
	const formik = useFormik({
		...
		onSubmit: async (values) => {
			...
			if (productId !== undefined) {
				try {
					await dispatch(
						updateProductData({ id: productId, prodData: values }),
					);
					dispatch(productResetState());
						...
						{isLoading ? ( // Show loading indicator when isLoading is true
                            ...
                            <div> */}
								<div className='form-group mt-2'>
									<label htmlFor='productTitle' className='label-name'>
										Product Title
									</label>
									<input
										type='text'
								...
								{/* Brand */}
								<div className='form-group mt-2'>
									<label htmlFor='brandSelect' className='label-name'>
										Brand
									</label>
									<select
										className={`form-control ${
								...
								{/* Category */}
								<div className='form-group mt-2'>
									<label htmlFor='categorySelect' className='label-name'>
										Category
									</label>
									<select
										className={`form-control ${
								...
								{/* Color */}
								<div className='form-group mt-2'>
									<label htmlFor='colorSelect' className='label-name'>
										Color
									</label>
									<Select
										isMulti
								...
								{/* Product Tags */}
								<div className='form-group mt-2'>
									<label htmlFor='TagSelect' className='label-name'>
										Tag
									</label>
									<select
										className={`form-control ${
								...
								{/* Product Price */}
								<div className='form-group mt-2'>
									<label htmlFor='productPrice' className='label-name'>
										Price
									</label>
									<input
										type='number'
								...
								{/* Product Quantity */}
								<div className='form-group mt-2'>
									<label htmlFor='productQuantity' className='label-name'>
										Quantity
									</label>
									<input
										type='number'
								...
								{/* image */}
								<div className='mt-2'>
									<label htmlFor='imageUpload' className='label-name'>
										Image
									</label>
								...
								<div className='showimages d-flex flex-wrap gap-3 product-border bg-white p-3'>
									{formik.values.images.length > 0 ? (
										...
										<p className='pt-2 fs-6 display_color2'>
											Loading images...
										</p>
									) : (
										<p className='pt-2 fs-6 display_color1'>
								...
								{/* Description */}
								<div className='mt-2'>
									<label htmlFor='productDescription' className='label-name'>
										Description
									</label>
									<textarea
										className={`form-control ${
