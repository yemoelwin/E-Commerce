...
const AddBlogCategory = () => {
	...
	const blgCategoryId =
		blogCatgoryIdSegment === "undefined" ? undefined : blogCatgoryIdSegment;
		...
		onSubmit: async (values) => {
			try {
				if (blgCategoryId !== undefined) {
					await dispatch(
						updateBlogCategory({ id: blgCategoryId, blgCatgoryData: values }),
					);
					...
					<div className='col-md-8'>
						<form onSubmit={formik.handleSubmit}>
							...
							<div className='form-group mt-2'>
								<label htmlFor='blogcategory' className='label-name'>
									Blog Category Title
								</label>
								<input
									type='text'
