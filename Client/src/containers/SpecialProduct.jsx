...
const SpecialProduct = (props) => {
  ...
  return (
    <div className='grid-container'>
      {specialData && specialData?.map((item, index) => {
          ...
          return (
            <div className="special-product-card mb-3" key={index}>
              <div className="d-flex justify-content-between">
                ...
                <div>
                  <img src={item?.images[0].url} className='img-fluid' alt="special" />
                </div>
                ...
                <div className='special-product-content'>
                  ...
                  />
                  <p className="price">
                    <span className="red-p">${item?.price}</span> &nbsp; <strike>$250</strike>
                  </p>
                  ...
                  <div className='prod-count my-3'>
                      ...
                      <div className="progress">
                        <div
                          ...
                          aria-valuenow={item?.quantity / item?.quantity + item?.sold * 100 }
                          aria-valuemin={item?.quantity}
                          aria-valuemax={item?.sold + item?.quantity}>
                        </div>
                      </div>
                  </div>
                  <Link className='button' to={`/product/${item?._id}`}>View Product</Link>
